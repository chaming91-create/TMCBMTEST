...
const isFailure=(r:ReplacementHistory,s:RiskSettings)=>!unknown(r.failureType)||s.failureKeywords.some(k=>`${r.replacementReason} ${r.failureType} ${r.removedStatus}`.includes(k));
