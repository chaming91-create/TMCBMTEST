...
export const DEFAULT_SETTINGS:RiskSettings={referenceYear:2026,weibullBeta:3.696,weibullEta:54.58,mkbf:38533,alpha:5,weights:{A:.38,F:.34,T:.18,M:.1},thresholds:{observation:30,caution:50,danger:80},failureKeywords:['고장','소손','단락','절연','베어링','진동','이상','파손'],formulaVersion:'1.0'};
