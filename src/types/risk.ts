...
export interface RiskScore { serialNo:string; AScore:number; FScore:number; TScore:number; MScore:number; riskScore:number; riskGrade:RiskGrade; isUncertain:boolean; uncertaintyReasons:string[]; calculatedAt:string; formulaVersion:string; }
